...
export const SEED_OUTFITS = [
  // ── Look 1: Summer Wedding Guest ───────────────────────────────────────────
  {
    ...
    critique: {
      ...
      verdictSource: 'rules',
      naturalLanguageCritique: 'Perfectly suited for a summer wedding. The draped dress balances elegance with comfort, and gold accessories tie the warm palette together beautifully.',
    },
  ...
  // ── Look 2: First Date ────────────────────────────────────────────────────
  {
    ...
    critique: {
      ...
      verdictSource: 'rules',
      naturalLanguageCritique: 'A solid date-night outfit. The chocolate + light wash + tan palette is harmonious and on-trend. The block heel is a practical choice for a walking date.',
    },
  ...
  // ── Look 3: Office / Professional ─────────────────────────────────────────
  {
    ...
    critique: {
      ...
      verdictSource: 'rules',
      naturalLanguageCritique: 'Exemplary professional attire. Each piece is versatile enough to remix with other wardrobe items. The cognac-navy-charcoal palette is sophisticated and timeless.',
    },
