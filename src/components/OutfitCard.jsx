...
function OutfitCard({
  ...
  // Auto-expand when reasoning data exists
  const hasReasoning = !!(reasoning?.confidenceBreakdown?.length);
  const [showWhy, setShowWhy] = useState(hasReasoning || showWhyThisWorks || false);
  ...
  return (
    <div className="outfit-card">
      ...
      <div className={`outfit-confidence-meter ${confidenceLevel}`}>
